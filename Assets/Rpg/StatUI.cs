...
public class StatUI : MonoBehaviour
{
    ...
    public void Btn_UpIt() { if (Stat.instance.maxstatpoint <= 0) { ShowMessage("포인트 부족!"); return; } if (Stat.instance.it >= 5) { ShowMessage("최대치 도달!"); return; } Stat.instance.upit(); }
    public void Btn_UpAtk() { if (Stat.instance.maxstatpoint <= 0) { ShowMessage("포인트 부족!"); return; } if (Stat.instance.atk >= 20) { ShowMessage("최대치 도달!"); return; } Stat.instance.upatk(); }
    public void Btn_UpSpd() { if (Stat.instance.maxstatpoint <= 0) { ShowMessage("포인트 부족!"); return; } if (Stat.instance.spd >= 10) { ShowMessage("최대치 도달!"); return; } Stat.instance.upspd(); }
    public void Btn_UpMaxHp() { if (Stat.instance.maxstatpoint <= 0) { ShowMessage("포인트 부족!"); return; } Stat.instance.upmaxhp(); }
    ...
    public void ShowLevelUp() => ShowMessage("Level Up!");
    private void HidePopup() { if (overstatPopup != null) overstatPopup.SetActive(false); }
}